---
title: "Q_1 triangle legacy seed: Psi^j X_i -> F"
...
# Q_1 triangle legacy seed: \(\Psi^jX_i\to F\)
...
$$
\widetilde{\mathcal O}_{\rm raw}^j{}_i(y_1,y_2):=\Psi^j_+(y_1)X_i(y_2),
\qquad
