...
\qquad
Q\bar\lambda_{\dot\beta}^B=0.
$$

$$
Q\mathcal O_{\dot\theta\dot\beta}^{AB}
=
\big(i\nabla_{+\dot\alpha}\widetilde\lambda^{A\dot\alpha}\big)\,
...
$$
Q_0\mathcal O_{\dot\theta\dot\beta}^{AB}=0.
$$

$$
Q_1\mathcal O_{\dot\theta\dot\beta}^{AB}
=
\big(i\nabla_{+\dot\alpha}\widetilde\lambda^{A\dot\alpha}\big)\,
\nabla_{+\dot\theta}\bar\lambda_{\dot\beta}^B.
$$
